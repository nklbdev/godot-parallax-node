...
const _ppb_class_name: String = "Parallax"
const _ppb_base_class_name: String = "Node2D"
const _ppb_script: GDScript = preload("res://addons/nklbdev.parallax/Parallax.gd")
